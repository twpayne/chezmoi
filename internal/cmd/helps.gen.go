...
var helps = map[string]*help{
	...
	"execute-template": {
		longHelp: "" +
			"Description:\n" +
			"  Execute templates. This is useful for testing templates /user-\n" +
			"  guide/templating.md#testing-templates or for calling chezmoi from other scripts.\n" +
			"  templates are interpreted as literal templates, with no whitespace added to the\n" +
			"  output between arguments. If no templates are specified, the template is read\n" +
			"  from stdin.",
		example: "" +
	...
	"init": {
		longHelp: "" +
			...
			"  site/user/r…│https://user@site/user/repo.git      │git@site:user/repo.git\n" +
			...
			"  the supported file formats (e.g. json, jsonc, toml, or yaml) then a new\n" +
			"  configuration file is created using that file as a template.\n" +
			"\n" +
			"  Then, if the --apply flag is passed, chezmoi apply is run.\n" +
			"\n" +
			"  Then, if the --purge flag is passed, chezmoi will remove its source, config, and\n" +
			"  cache directories.\n" +
			"\n" +
			"  Finally, if the --purge-binary is passed, chezmoi will attempt to remove its own\n" +
			"  binary.",
		example: "" +
			"  chezmoi init user\n" +
	...
	"remove": {
		longHelp: "" +
			"Description:\n" +
			"  The remove command has been removed. Use the forget command /forget.md or the\n" +
