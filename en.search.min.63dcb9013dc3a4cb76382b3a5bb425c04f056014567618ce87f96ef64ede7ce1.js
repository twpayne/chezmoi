...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.354b236cca8e264f784a1420bc0f263feae72b35d363188304d9884afc38a2a9.js',function(){input.required=false;search();});}
