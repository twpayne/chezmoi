...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.8e2cd3c7377df71b1066f3be8dd00bf365a598ed9583520b61356a3a1211a682.js',function(){input.required=false;search();});}
