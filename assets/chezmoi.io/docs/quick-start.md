...
!!! hint
    ...
    chezmoi can be configured to automatically [add, commit, and push](daily-operations/index.md#automatically-commit-and-push-changes-to-your-repo) changes to
    your repo.
