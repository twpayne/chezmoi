...
Register-ArgumentCompleter -Native -CommandName 'chezmoi' -ScriptBlock {
    ...
    $completions = @(switch ($command) {
        'chezmoi' {
            ...
            [CompletionResult]::new('-x', 'x', [CompletionResultType]::ParameterName, 'exclude entry types')
            [CompletionResult]::new('--exclude', 'exclude', [CompletionResultType]::ParameterName, 'exclude entry types')
