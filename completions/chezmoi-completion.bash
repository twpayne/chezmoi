...
_chezmoi_add()
{
    ...
    flags+=("--template-symlinks-home")
    local_nonpersistent_flags+=("--template-symlinks-home")
    flags+=("--template-symlinks-source")
    local_nonpersistent_flags+=("--template-symlinks-source")
    flags+=("--color=")
