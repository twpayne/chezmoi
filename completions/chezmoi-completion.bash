...
_chezmoi_add()
{
    ...
    flags+=("--template-symlinks")
    local_nonpersistent_flags+=("--template-symlinks")
    flags+=("--color=")
...
_chezmoi_diff()
{
    ...
    local_nonpersistent_flags+=("-i")
    flags+=("--pager=")
    two_word_flags+=("--pager")
    local_nonpersistent_flags+=("--pager")
    local_nonpersistent_flags+=("--pager=")
    flags+=("--recursive")
    flags+=("-r")
    local_nonpersistent_flags+=("--recursive")
...
_chezmoi_state_data()
{
    last_command="chezmoi_state_data"
...
_chezmoi_state_delete()
{
    last_command="chezmoi_state_delete"
...
_chezmoi_state_get()
{
    last_command="chezmoi_state_get"
...
_chezmoi_state_set()
{
    last_command="chezmoi_state_set"
